...
public class b2Vec2
{
	public function b2Vec2(x_:Number=0, y_:Number=0){x=x_; y=y_;};

	public function SetZero() { x = 0.0; y = 0.0; }
	public function Set(x_:Number=0, y_:Number=0){x=x_; y=y_;};
	public function SetV(v:b2Vec2){x=v.x; y=v.y;};
	...
	public function Multiply(a:Number)
	{
		x *= a; y *= a;
	}
	...
	public function CrossVF(s:Number){
		var tX:Number = x;
		x = s * y;
		y = -s * tX;
	}
	
	public function CrossFV(s:Number){
		var tX:Number = x;
		x = -s * y;
		y = s * tX;
	}
