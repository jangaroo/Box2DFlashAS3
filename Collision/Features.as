...
{
	//
	public function set referenceFace(value:int){
	...
	//
	public function set incidentEdge(value:int){
		_incidentEdge = value;
	...
	//
	public function set incidentVertex(value:int){
	...
	//
	public function set flip(value:int){
		_flip = value;
