...
public class b2Joint
{
	...
	static public function Destroy(joint:b2Joint, allocator:*){
		/*joint->~b2Joint();
		switch (joint.m_type)
		{
		case e_distanceJoint:
	...
	public virtual function PrepareVelocitySolver(){};
	public virtual function SolveVelocityConstraints(step:b2StepInfo){};

	// This returns true if the position errors are within tolerance.
	public virtual function PreparePositionSolver(){};
