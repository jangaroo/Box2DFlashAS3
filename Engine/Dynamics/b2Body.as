...
public class b2Body
{
	...
	public function SetOriginPosition(position:b2Vec2, rotation:Number){
		if (IsFrozen())
		{
			return;
		}
	...
	// This breaks any contacts and wakes the other bodies.
	public function SetCenterPosition(position:b2Vec2, rotation:Number){
		if (IsFrozen())
		{
			return;
		}
	...
	public function SetAngularVelocity(w:Number){
		m_angularVelocity = w;
	}
	...
	public function AllowSleeping(flag:Boolean){
		if (flag)
		{
